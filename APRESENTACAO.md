...
**O que fizemos.** Testamos 17 fontes públicas, uma por uma, e descartamos quatro que não serviam. Depois construímos o sistema todo, da coleta até a API, com 190 testes automáticos. E o painel, que é onde isso vira coisa de olhar.
...
**1.** `pytest` mostra os 190 testes passando em 4 segundos.
